...
public class ParentController {
	...
	public List<ParentDTO> listParentChildrens(@PathVariable("tenantId") long tenantId,@RequestBody StudentClassroom studentClassroom) {
	...
	public List<TestTransferObject> studentMarks(@PathVariable("tenantId") long tenantId,@RequestBody ParentDTO parentDTO) {
	...
	public List<AttendanceDTO> attendanceReport(@PathVariable("tenantId") long tenantId,@RequestBody StudentClassroom studentClassroom) {

...
INSERT INTO schools(code, sname,dateofestablishment, timezone, dbname, statusid,url)
			VALUES('oakridge','Oakridge High School','2017-06-15','Asia/Calcutta','oakridge',1,'iSchoolOakridge'),
				  ('DPS','Delhi Public High School','2017-06-15','Asia/Calcutta','dps',1,'iSchooldps');
